...
addon_info = {
	...
	"addon_description": _("""This addon calculates the body apple index."""),
	# version
	"addon_version": "1.0",
	# Author(s)
	"addon_author": "Edilberto Fonseca <edilberto.fonseca@outlook.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/EdilbertoFonseca/imc",
...
mainPaht = os.path.join('addon', 'globalPlugins', 'IMC')
pythonSources = [
